...
describe("Comprobación del dinero", function () {
    it("Valores negativos, 0 y null no deben ser legales",
        function () {
            //expect(reloj.esMonedaValida()).toBeFalse()
            //expect(reloj.esMonedaValida(0)).toBeFalse()
            //expect(reloj.esMonedaValida(-10)).toBeFalse()
        });
    it("Valor distinto de 0.05, 0.10, 0.20, 0.50, 1, 2, 5, 10, 20, 50, 100, 200 y 500 debe dar false",
        function () {
            //expect(reloj.esMonedaValida(0.23)).toBeFalse()
        });
    it("Valor igual a uno de 0.05, 0.10, 0.20, 0.50, 1, 2, 5, 10, 20, 50, 100, 200 y 500 debe dar true",
        function () {
            //expect(reloj.esMonedaValida(0.05)).toBeTrue()
            //expect(reloj.esMonedaValida(0.10)).toBeTrue()
            //expect(reloj.esMonedaValida(0.20)).toBeTrue()
            //expect(reloj.esMonedaValida(0.50)).toBeTrue()
            //expect(reloj.esMonedaValida(1)).toBeTrue()
            //expect(reloj.esMonedaValida(2)).toBeTrue()
            //expect(reloj.esMonedaValida(5)).toBeTrue()
            //expect(reloj.esMonedaValida(10)).toBeTrue()
            //expect(reloj.esMonedaValida(20)).toBeTrue()
            //expect(reloj.esMonedaValida(50)).toBeTrue()
            //expect(reloj.esMonedaValida(100)).toBeTrue()
            //expect(reloj.esMonedaValida(200)).toBeTrue()
            //expect(reloj.esMonedaValida(500)).toBeTrue()
        });
});
...
=================================================================
   Segunda parte: 
=================================================================
En los siguientes expect que debes escribir, debes llamar a la función: reloj.suficienteParaPagar
...
describe("Pago de una factura:", function () {
    ...
    it("La suma del vector menor que el montante, devuelve 0",
        function () {
            // Escribe dos expect que para un vector de reloj válidas y un valor a pagar mayor que la suma de dichas reloj, conpruebe que devuelve 0
        }
    );
    it("La suma del vector igual que el montante, devuelve 1",
        function () {
             // Escribe dos expect que para un vector de reloj válidas y un valor a pagar exactamente igual que la suma de dichas reloj, conpruebe que devuelve 1
        }
    );

    it("La suma del vector mayor que el montante, devuelve 2",
        function () {
            // Escribe dos expect que para un vector de reloj válidas y un valor a pagar menor que la suma de dichas reloj, conpruebe que devuelve 2
        }
    );
});